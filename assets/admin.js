/*
 * asset/admin.js - Versione 2.4.10
...
jQuery(document).ready(function($) {
    ...
    function toggleProductSettingsVisibility($group) {
        ...
        // Determina se mostrare o nascondere MIN/STEP per prodotto
        const showProductMinStep = ['quantity', 'multiple_quantity'].includes(mode);
        
        // Per ogni riga prodotto nel gruppo, gestisci la visibilità
