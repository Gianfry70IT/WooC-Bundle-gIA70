        ...
        <?php foreach ( $bundle_groups as $group_index => $group ) : ?>
            ...
            <div class="wcb-bundle-group" 
                    ...
                    <?php
                        ...
                        switch ($selection_mode) {
                            ...
                            case 'quantity':
                                ...
                                if ($total > 0) {
                                    $rules[] = sprintf(__('Scegli esattamente %d prodotti', 'wcb-framework'), $total);
                                }
                                break;
                        }
                ...
                <?php if ( $selection_mode === 'personalization_only' ) : ?>
                    <div class="wcb-group-personalization-only">
                        <?php if ($personalization_enabled) : ?>
                            <div class="wcb-personalization-field">
                                ...
                                <input type="text" class="wcb-personalization-input" name="wcb_personalization[<?php echo esc_attr($group_index); ?>][personalization_only]">
                            </div>
                        <?php endif; ?>
                    </div>
                <?php else : ?>
